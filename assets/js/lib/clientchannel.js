            ...
            let Ownership = (() => {
                class Ownership {
                    ...
                    take(key, age, wait) {
                        ...
                        return wait === void 0 ? true : new promise_1.AtomicPromise(resolve => setTimeout(resolve, wait)).then(() => this.extend(key, age) ? promise_1.AtomicPromise.resolve() : promise_1.AtomicPromise.reject());
                    }
                    extend(key, age) {
