module.exports = function (config) {
  config.set({
    ...
    frameworks: ['mocha'],
    files: [
      { pattern: 'https://cdn.polyfill.io/v2/polyfill.js?features=default,WeakMap,WeakSet,Array.prototype.findIndex&flags=gated', watched: false, served: false, included: true },
